...
<table width="560" border="1">
  ...
  $kq=mysql_query("select * from webtm_sanpham where idLoai=$idLoai");
  ...
  //Lay du lieu:
  $sl="select * from webtm_sanpham where idLoai=$idLoai limit $vitri,$sd";
  $kqsp=mysql_query($sl);
...
for($i=1;$i<=$tst;$i++){
	...
	?><a href="pt_loaisp.php?page=<?php echo $i;?>&idLoai=<?php echo $idLoai;?>"><?php echo $i;?></a> &nbsp;<?php 
	} //ket thuc else
} // ket thuc for
