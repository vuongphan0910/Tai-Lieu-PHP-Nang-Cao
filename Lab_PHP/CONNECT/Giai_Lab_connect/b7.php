...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>
	...
	?>
      <option value="<?php echo $dlsp['idLoai'];?>" <?php if(isset($_POST['loaisp'])&&$_POST['loaisp']==$dlsp['idLoai']) echo "selected='selected'";?>><?php echo $dlsp['TenLoai'];?></option>
     <?php }?>
    </select>
  </p>
...
<?php
	...
	if(isset($_POST['loaisp']))	$idLoai=$_POST['loaisp'];
